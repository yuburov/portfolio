...
export default function BackgroundCircles() {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#333333] rounded-full h-[370px] w-[370px] mt-52" />
      <div className="rounded-full border border-[#F7AB0A] opacity-20 h-[470px] w-[470px] absolute mt-52 animate-pulse" />
